    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          {person.department && (
            <p className="text-[10px] text-gray-400 mt-0.5">{person.department}</p>
          )}
        </div>
      </div>
      ...
      <div className="mt-3 space-y-1.5">
        {person.email && (
          <a
            ...
            className="flex items-center gap-2 text-xs text-gray-600 hover:text-teal-700 transition-colors"
